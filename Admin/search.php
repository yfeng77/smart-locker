<?php 
    ...
    $sql1 = "SELECT * FROM admin WHERE aid=".$_SESSION['admin'];
    $result1 = mysqli_query($db,$sql1);
    $userRow = mysqli_fetch_array($result1,MYSQLI_ASSOC);

    // Error & success messages
    global $success_msg, $failed_msg;

    $search = $_POST['searchname'];
    
    $sql2 = "SELECT * FROM form WHERE sname like '%$search%'";
    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Search Result - <?php echo $search; ?></h3>
                    <div class="card shadow">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                   <div class="col offset-xl-6 text-center">
                                    <button class="btn btn-primary align-items-center" type="button" onclick="window.location.href='history.php';">Back</button>
                                    </div>
                                </div>
                            </div>
                        </div>
